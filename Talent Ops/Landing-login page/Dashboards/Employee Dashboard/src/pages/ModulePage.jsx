...
const ModulePage = ({ title, type }) => {
    ...
    const [leaveRequests, setLeaveRequests] = useState([
        ...
        { id: 4, name: 'Alex Morgan', type: 'Sick Leave', duration: '1 Day', dates: 'Nov 15', status: 'Approved' },
        { id: 5, name: 'Alex Morgan', type: 'Vacation', duration: '3 Days', dates: 'Dec 28 - Dec 30', status: 'Pending' },
    ]);
    ...
    const configs = {
        workforce: {
            ...
            data: filterData([
                { id: 1, name: 'Alice Johnson', email: 'alice@company.com', role: 'Senior Dev', dept: 'Engineering', status: 'Active', joinDate: 'Jan 12, 2023', phone: '+1 (555) 123-4567', location: 'San Francisco, CA', employee: 'Mike Ross', performance: '92%', projects: 5, tasksCompleted: 127 },
                { id: 2, name: 'Bob Smith', email: 'bob@company.com', role: 'Product Owner', dept: 'Product', status: 'Active', joinDate: 'Mar 05, 2022', phone: '+1 (555) 234-5678', location: 'New York, NY', employee: 'Jessica Pearson', performance: '88%', projects: 3, tasksCompleted: 94 },
                { id: 3, name: 'Charlie Brown', email: 'charlie@company.com', role: 'Designer', dept: 'Design', status: 'On Leave', joinDate: 'Jun 15, 2023', phone: '+1 (555) 345-6789', location: 'Austin, TX', employee: 'Diana Prince', performance: '95%', projects: 4, tasksCompleted: 78 },
                { id: 4, name: 'Diana Prince', email: 'diana@company.com', role: 'Marketing Lead', dept: 'Marketing', status: 'Active', joinDate: 'Aug 22, 2021', phone: '+1 (555) 456-7890', location: 'Los Angeles, CA', employee: 'Harvey Specter', performance: '90%', projects: 6, tasksCompleted: 156 },
                { id: 5, name: 'Evan Wright', email: 'evan@company.com', role: 'Sales Rep', dept: 'Sales', status: 'Active', joinDate: 'Nov 01, 2023', phone: '+1 (555) 567-8901', location: 'Chicago, IL', employee: 'Harvey Specter', performance: '85%', projects: 2, tasksCompleted: 63 },
            ])
        },
        status: {
            columns: [
            ...
            data: filterData([
                ...
                { name: 'Alex Morgan', dept: 'Engineering', availability: 'Online', task: 'Developing Dashboard', lastActive: 'Now' },
        ...
        leaves: {
            ...
            data: leaveRequests.filter(req => req.name === userName)
        },
        payroll: {
            columns: [
                { header: 'Team Member', accessor: 'name' },
            ...
            data: [
                ...
                { name: 'Alex Morgan', month: 'October 2025', salary: '$5,500', status: 'Paid' },
                { name: 'Alex Morgan', month: 'November 2025', salary: '$5,500', status: 'Paid' },
