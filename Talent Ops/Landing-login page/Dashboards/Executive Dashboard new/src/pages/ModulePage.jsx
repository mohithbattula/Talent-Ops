...
const ModulePage = ({ title, type }) => {
    ...
    const [employees, setEmployees] = useState([
        { id: 1, name: 'Alice Johnson', email: 'alice@company.com', role: 'Senior Dev', dept: 'Engineering', status: 'Active', joinDate: 'Jan 12, 2023', phone: '+1 (555) 123-4567', location: 'San Francisco, CA', executive: 'Mike Ross', performance: '92%', projects: 5, tasksCompleted: 127 },
        { id: 2, name: 'Bob Smith', email: 'bob@company.com', role: 'Product Owner', dept: 'Product', status: 'Active', joinDate: 'Mar 05, 2022', phone: '+1 (555) 234-5678', location: 'New York, NY', executive: 'Jessica Pearson', performance: '88%', projects: 3, tasksCompleted: 94 },
        { id: 3, name: 'Charlie Brown', email: 'charlie@company.com', role: 'Designer', dept: 'Design', status: 'On Leave', joinDate: 'Jun 15, 2023', phone: '+1 (555) 345-6789', location: 'Austin, TX', executive: 'Diana Prince', performance: '95%', projects: 4, tasksCompleted: 78 },
        { id: 4, name: 'Diana Prince', email: 'diana@company.com', role: 'Marketing Lead', dept: 'Marketing', status: 'Active', joinDate: 'Aug 22, 2021', phone: '+1 (555) 456-7890', location: 'Los Angeles, CA', executive: 'Harvey Specter', performance: '90%', projects: 6, tasksCompleted: 156 },
        { id: 5, name: 'Evan Wright', email: 'evan@company.com', role: 'Sales Rep', dept: 'Sales', status: 'Active', joinDate: 'Nov 01, 2023', phone: '+1 (555) 567-8901', location: 'Chicago, IL', executive: 'Harvey Specter', performance: '85%', projects: 2, tasksCompleted: 63 },
    ]);
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-lg)' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                {(type === 'leaves' || type === 'workforce' || type === 'recruitment') && (
                    <button
                        onClick={() => handleAction(type === 'leaves' ? 'Apply for Leave' : type === 'workforce' ? 'Add Employee' : 'Add Candidate')}
                        style={{
                    ...
                    >
                        <Plus size={20} />
                        {type === 'leaves' ? 'Apply for Leave' : type === 'workforce' ? 'Add Employee' : 'Add Candidate'}
                    </button>
                )}
            </div>
                    ...
                    <div style={{ backgroundColor: 'var(--surface)', padding: '32px', borderRadius: '16px', width: '500px', maxWidth: '90%', maxHeight: '90vh', overflowY: 'auto', boxShadow: 'var(--shadow-lg)' }}>
                        ...
                        <form onSubmit={handleAddEmployee} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                                ...
                                <div>
                                    <label style={{ display: 'block', fontSize: '0.9rem', fontWeight: 500, marginBottom: '8px', color: 'var(--text-primary)' }}>Department</label>
                                    <input
                                        type="text"
